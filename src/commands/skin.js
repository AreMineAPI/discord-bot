...
module.exports = {
    name: "skin",
    description: "Check a Minecraft account skin.",
    options: [
        {
            type: 3,
            name: "username",
        ...
        try {
            ...
            await interaction.followUp({
                embeds: [
                    ...
                    .setDescription(`ℹ️ **Information:** *Download the skin: [Click](https://api.mineapi.me/download/skin/${data.name})*`)
                    .setImage(`https://api.mineapi.me/v1/skin/${data.name}`)
                ]
            });
        } catch(err) {
            await interaction.followUp({
